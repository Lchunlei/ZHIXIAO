...
layui.use(['table', 'jquery','form', 'admin'], function() {
	...
	table.render({
		...
		cols: [
			[{
				...
				field: 'adminId',width: 60,title: 'ID'
			}, {
				field: 'phoneNum',title: '手机号'
			}, {
                field: 'nickName',title: '称呼'
            }, {
				field: 'usable',title: '状态',templet: '#usableTep'
            }, {
				field: 'sysRole',title: '角色',templet: '#sysRoleTep'
            }, {
	...
	var active = {
		...
		getCheckData: function() { //获取选中数据
			var checkStatus = table.checkStatus('sysAdmins'),
    ...
    window.updateAdmin = function (adminId){
        $.ajax({
            url:"../../../pc/admin/use?adminId="+adminId
            ,type:"GET"
