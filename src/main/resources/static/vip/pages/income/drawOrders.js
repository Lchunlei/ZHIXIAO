    ...
    function initWeb() {
        table.render({
            ...
            cols: [
                [{
                    ...
                    field: 'drawMoneyYuan',title: '提现金额'
                }, {
                    field: 'realDrawMoneyYuan',title: '到账金额'
                }, {
                    field: 'serviceMoneyYuan',title: '手续费'
                }, {
                    field: 'drawWay',title: '提现渠道'
                }, {
                    field: 'drawWayUser',title: '户主'
                }, {
                    field: 'drawWayAccount',title: '收款账号'
                }, {
        ...
        var active = {
            ...
            getCheckData: function() { //获取选中数据
                var checkStatus = table.checkStatus('drawOrders'),
