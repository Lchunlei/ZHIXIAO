    ...
    function initWeb() {
        table.render({
            ...
            cols: [
                [{
                    ...
                    field: 'webBid',width: 60,title: 'ID'
                }, {
                    field: 'moneyYuan',title: '提现金额'
                }, {
                    field: 'ins',title: '备注',templet: '#insTep'
                }, {
        ...
        var active = {
            ...
            getCheckData: function() { //获取选中数据
                var checkStatus = table.checkStatus('myBIncomes'),
